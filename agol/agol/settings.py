"""
Django settings for agol project.
...
SECRET_KEY = 'django-insecure-a=xa%e)t9n7j43brlnx%dngzdpetdnkwk^zl73hxb*d_*^i7*n'
...
WSGI_APPLICATION = 'agol.wsgi.application'
